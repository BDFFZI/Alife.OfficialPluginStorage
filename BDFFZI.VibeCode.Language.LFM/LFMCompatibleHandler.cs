...
/// <summary>
/// LFM（Liquid Foundation Models）走的是 OpenAI 兼容协议。
/// 此处理器用于拦截各厂商的原始流，自动识别并捕获思维链内容
/// （reasoning_content, thought, thinking, reasoning 等），
/// 将其统一封装为带前缀的 content 字段，确保上层能显示思考过程。
/// </summary>
public class LFMCompatibleHandler(HttpMessageHandler innerHandler) : DelegatingHandler(innerHandler)
{
